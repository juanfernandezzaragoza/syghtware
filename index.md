...
- Capítulo 6: Estamos a hombros de gigantes.
    - Las herramientas de modelado de entonces no podían tratar sistemas complejos.

**Parte III: Podemos reescribir *El Capital.***
- Capítulo 7: El capital es una red social.
- Capítulo 8: Por eso se concentra. 
    - La centralización de capital se debe a los efectos de red.
    - El liderazgo de redes sociales es la forma general de la explotación.
    - Este modelo es más explicativo que los anteriores.
